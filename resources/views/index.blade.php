                                    ...
                                    <div class="row g-0">
                                        <div class="col-12">
                                            ...
                                            <ul class="navigation">
                                                ...
                                                <li>
                                                    <a href="#0" id="works-trigger" class="navigation__link"
                                                        data-ref="works">
                                                        <span class="nav-star"></span>
                                                ...
                                                <li>
                                                    <a href="#0" id="contact-trigger" class="navigation__link"
                                                        data-ref="contact">
                                                        <span class="nav-star"></span>
                                        ...
                                        <div class="col-12 col-lg-4 menudata__item">
                                            ...
                                            <p class="menudata__text">
                                                <a class="contact-link"
                                                    href="mailto:example@example.com?subject=Message%20from%20your%20site">grynome@gmail.com</a>
                                            </p>
                                        </div>
                    ...
                    <div class="col-12 col-lg-8 main__intro">
                        ...
                        <div class="intro__content">
                            ...
                            <div id="headline" class="headline">
                                <h1 class="headline__title">PHP Developer and Database Administrator</h1>
                                        ...
                                        <span class="circle">
                                            <i class="circle__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="25px" height="25px"
                                                    viewBox="0 0 25 25">
                                                    <path fill="#393C44"
                                                        d="M25,4.8V24v1h-1H3.8v-1h19.5L0,0.7L0.7,0L24,23.3V4.8H25z" />
                                                </svg>
                                            </i>
                                        </span>
                                ...
                                <div class="blocks__container">
                                    <div class="content-block">
                                        <div class="container-fluid px-0">
                                            <div class="row gx-5">
                                                <div class="col-12">
                                                    <h2 class="inner__title animate-in-up">Creativity is above all. Just
                                                        awesome template.</h2>
                                                </div>
                                ...
                                <div class="blocks__container">
                                    <div class="content-block">
                                        <div class="container-fluid px-0 works__gallery">
                                            <div class="row gx-5 gy-5 my-gallery" itemscope
                            ...
                            <div class="blocks__scroll">
                                    ...
                                    <div class="content-block">
                                        <div class="container-fluid px-0">
                                            <div class="row gx-5">
                                                ...
                                                <div class="col-12 col-md-8">
                                                    <p class="inner__text">Let's get in touch. You can call us or leave a
                                                        request here.
                                                        We are always glad to see you in our office from <span>9:00 to
                                                            18:00</span>.</p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row gx-5 gy-5 align-items-stretch">
                                                        ...
                                                        <div class="contactdata__descr">
                                                            <p class="small">
                                                                <a class="contact-link"
                                                                    ...
                                                                    target="_blank">11 West 53 Street,<br>New York, NY
                                                                    10019</a>
                                                            </p>
                                                            <p class="small">
                                                                <a class="contact-link"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="contactdata__descr">
                                                            <ul class="contactdata__socials">
                                                                ...
                                                                <li>
                                                                    <a class="contact-link" href="https://pinterest.com/"
                                                ...
                                                <div class="col-12 col-md-6 col-xl-4">
                                                    <div
                                                        ...
                                                        <div class="contactdata__descr">
                                                            <p class="small">
                                                                <a class="contact-link" href="tel:+12127089400">+1
                                                                    212-708-9400</a>
                                                                <br>
                                                                <a class="contact-link" href="tel:+15104570211">+1
                                                                    510-457-0211</a>
                                                            </p>
                                                            <p class="small">
                                                                <a class="contact-link"
                                ...
                                <div class="blocks__container">
                                    ...
                                    <div class="content-block">
                                        ...
                                        <p class="block__text">Want to know more about my work, tell me about your project
                                    ...
                                    <div class="content-block">
                                        <div class="form-container">
                                            ...
                                            <div class="reply-group">
                                                ...
                                                <span class="reply-group__text">Thanks for your message. We will get back
                                            ...
                                            <form class="form form-dark contact-form" id="contact-form">
                                                ...
                                                <input type="hidden" name="project_name"
                                                    value="Emeric - Coming Soon & Portfolio Template">
